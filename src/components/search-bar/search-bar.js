...
export function createSearchBar(onSearch = () => {}) {
  ...
  searchBar.innerHTML = `
    <div class="flex w-full border border-white/10 bg-white/10">
      ...
      <button
        type="submit"
       class="cursor-pointer border-l border-white/10 px-3 font-mono text-sm tracking-wide text-black transition-colors hover:text-white sm:px-5 sm:text-base bg-amber-500"
      >
        Search
      </button>
    </div>
